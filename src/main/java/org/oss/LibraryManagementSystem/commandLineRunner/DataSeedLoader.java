...
public class DataSeedLoader implements CommandLineRunner {
    ...
    private void loadUserData() throws ParseException {
        ...
        var user1 = new User("NguyenTrung", "Kien", "$2a$10$VfwjyGYDVeXiWpJAnV9kQOyykSJZDbzR8YLcyneE1rQnhsrPh9gnS", "ntk04@gmail.com", new Timestamp(new SimpleDateFormat("yyyy/MM/dd").parse("2004/10/30").getTime()), "+4444444444", true, roles);

        var user2 = new User("VuGia", "Khai", "$2a$10$xktQ8dzEhsPkgU2Zm6iyhuKSYqWU/FzkfESwUs/8gfr7ZkKvsEurq", "vgk04@gmail.com", new Timestamp(new SimpleDateFormat("yyyy/MM/dd").parse("2004/10/20").getTime()), "+5555555555", true, roles);

        var user3 = new User("NguyenVan", "Nam", "$2a$10$wYATg6cU5pY0ZkpqbMkII.b6kWcOjnpdnQg2mM6jkn2wdwYkNkFNK", "nam04@gmail.com", new Timestamp(new SimpleDateFormat("yyyy/MM/dd").parse("2004/05/19").getTime()), "+6666666666", true, roles);
